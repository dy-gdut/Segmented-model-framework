...
from model.models.layers import unetConv2
from model.models.init_weights import init_weights
...
if __name__ == "__main__":
    ipt = torch.rand(2, 1, 128, 384)

    # unet1=UNet(2,base_channels=32,level=4)
    # opt = unet1(ipt)
    # print(opt.shape)

    unet3 = UNet_3Plus(n_classes=2, in_channels=1)
    opt = unet3(ipt)
    print(opt.shape)
